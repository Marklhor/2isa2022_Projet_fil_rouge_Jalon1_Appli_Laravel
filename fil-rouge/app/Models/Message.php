...
class Message extends Model
{
    ...
    public function getAllMessagesForTicket(int $IdTicket)
    {
         ...
         */
        return DB::select("SELECT mt.IdMessage as 'id', t.sujet as 'sujet' ,st.Id as 'id_status',st.Label as 'status_label', mt.IdTicket as 'id_ticket', um.Content as 'msg', u.id as 'id_user', CONCAT(u.name, ' ', LEFT(u.firstname, 1), '.') AS 'nom', um.CreateAt as 'date_message', t.CreatedAt as 'date_de_creation', t.UpdateAt as 'date_de_maj', ur.IdRole as 'id_role', t.IdTypePanne, pt.Label as 'label_panne'
